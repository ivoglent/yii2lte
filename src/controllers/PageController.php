...
class PageController extends Controller
{
    ...
    public function init()
    {
        ...
        $this->baseAssetUrl = \Yii::$app->assetManager->getBundle(\ivoglent\yii2lte\assets\AppAsset::className())->baseUrl;
    }
     ...
     * @return string
     */
    public function actionExampleLogin() {
        $this->layout = '//simple';
        return $this->render('example-login');
    }

    /**
     * @return string
     */
    public function actionExampleRegister() {
        $this->layout = '//simple';
        return $this->render('example-register');
    }
    /**
     * @return string
     */
